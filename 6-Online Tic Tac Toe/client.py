...
############################## button#############################################################
btn1 = Button(window, text=" ", bg="yellow", fg="black",
              width=3, height=1, command=clicked1)
btn1.grid(row=0, column=1)

btn2 = Button(window, text=" ", bg="yellow", fg="black",
              width=3, height=1, command=clicked2)
btn2.grid(row=0, column=2)

btn3 = Button(window, text=" ", bg="yellow", fg="black",
              width=3, height=1, command=clicked3)
btn3.grid(row=0, column=3)

btn4 = Button(window, text=" ", bg="yellow", fg="black",
              width=3, height=1, command=clicked4)
btn4.grid(row=1, column=1)

btn5 = Button(window, text=" ", bg="yellow", fg="black",
              width=3, height=1, command=clicked5)
btn5.grid(row=1, column=2)

btn6 = Button(window, text=" ", bg="yellow", fg="black",
              width=3, height=1, command=clicked6)
btn6.grid(row=1, column=3)

btn7 = Button(window, text=" ", bg="yellow", fg="black",
              width=3, height=1, command=clicked7)
btn7.grid(row=2, column=1)

btn8 = Button(window, text=" ", bg="yellow", fg="black",
              width=3, height=1, command=clicked8)
btn8.grid(row=2, column=2)

btn9 = Button(window, text=" ", bg="yellow", fg="black",
              width=3, height=1, command=clicked9)
